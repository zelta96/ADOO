...
<section class="info">
	<article id="prueba"class="in">
		<p><br><br><br><br><br><br><br>Sé Bienvenido  cliente a este espacio de gestión para tus proyectos.<br><br><br>Selecciona una de las opciones de la izquierda para continuar.</p>
	</article>
	</section>
